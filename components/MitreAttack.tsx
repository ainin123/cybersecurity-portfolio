              ...
              <div key={tactic.id} style={{ display: "flex", alignItems: "center" }}>
                <div
                  style={{
                    padding: "8px 14px",
                    borderRadius: "6px",
                    backgroundColor: hoveredId === tactic.id ? "rgba(0,229,255,0.15)" : "rgba(17,34,64,0.8)",
                  ...
                  >
                    <div
                      style={{
                        ...
                        borderLeft: "6px solid rgba(0,229,255,0.3)",
                      }}
                    />
                  </div>
                )}
              ...
              >
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "4px", marginBottom: "14px" }}>
                  ...
                  {!isHovered && tactic.techniques.length > 3 && (
                    <span style={{ fontSize: "10px", color: "rgba(0,229,255,0.5)", fontFamily: "monospace" }}>
                ...
                <div>
                  ...
                  >
                    <span style={{ fontSize: "10px", color: "#8892B0", fontFamily: "monospace" }}>
                      Proficiency
                    </span>
