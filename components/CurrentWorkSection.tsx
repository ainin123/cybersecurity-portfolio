...
const CURRENT_WORK = [
  ...
  {
    icon: Activity,
    iconColor: "rgba(37,150,190,0.5)",
    iconBg: "rgba(37,150,190,0.06)",
    title: "UEBA Research",
    description:
    ...
    >
      ...
      <div
        style={{
          ...
          pointerEvents: "none",
          background:
            "radial-gradient(ellipse 60% 50% at 50% 0%, rgba(37,150,190,0.03) 0%, transparent 60%)",
        }}
      />
